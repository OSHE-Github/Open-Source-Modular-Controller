...
void gamepad1::buttons(uint32_t bt)
{
    report.buttons = bt;
    sendReport();
}

void gamepad1::joystick1(int8_t x, int8_t y, int8_t z)
{
    report.x = x;
    report.y = y;
    report.z = z;
...
void gamepad1::joystick2(int8_t rx, int8_t ry, int8_t rz)
{
    report.Rx = rx;
    report.Ry = ry;
    report.Rz = rz;
...
void gamepad1::sendAll(uint32_t bt, int8_t x, int8_t y, int8_t z, int8_t rx, int8_t ry, int8_t rz, uint8_t hat)
{
    report.buttons = bt;
    report.x = x;
    report.y = y;
